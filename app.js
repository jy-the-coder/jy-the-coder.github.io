...
class RestaurantIntelligencePlatform {
            ...
            if (displayData && displayData.length > 0) {
                ...
                if (hasAnyData) {
                    cuisineEmpty.innerHTML = `
                        <div class="empty-state">
                            <div class="empty-state-icon">Cuisine Analysis</div>
    ...
    displayInsights(insights) {
        ...
        if (insights.length === 0) {
            container.innerHTML = `
                <div class="empty-state">
                    <div class="empty-state-icon">Strategic Insights</div>
    ...
    showHelpModal() {
        ...
        this.log('Help modal shown');
    }
    
    hideHelpModal() {
        document.getElementById('helpModal').classList.remove('show');
        document.body.style.overflow = '';
        this.log('Help modal hidden');
    }
}

document.addEventListener('DOMContentLoaded', () => {
    console.log('Initializing Restaurant Business Intelligence Platform...');
